...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('roulette_vote', 'value', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Vote.value'
        db.alter_column('roulette_vote', 'value', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'roulette.bullet': {
            ...
            'date_submitted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 31, 13, 32, 25, 748879)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'roulette.round': {
            ...
            'round_end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 1, 13, 32, 25, 748349)', 'blank': 'True'})
        },
        'roulette.vote': {
